...
#appends the words onto the end to generate a file path

# now check to make sure this path is correct by seeing if the files exist. All summarizes everything to one output from the logical vector of file.exists
